...
par(mfcol=c(2,2))
with(dat,{
  plot(dat$Datetime,dat$Global_active_power,col="black",xlab="",ylab="Global Active Power",type="l")
  {
  ...
  plot(dat$Datetime,dat$Voltage,col="black",xlab="datetime",ylab="Voltage",type="l")
  plot(dat$Datetime,dat$Global_reactive_power,col="black",xlab="datetime",ylab="Global_reactive_power",type="l")
})
dev.off()